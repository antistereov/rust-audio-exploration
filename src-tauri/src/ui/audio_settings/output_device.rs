...
#[tauri::command]
pub fn list_available_output_devices(audio_handler: tauri::State<Mutex<AudioHandler>>) -> Result<Vec<String>, AudioHandlerError> {
    audio_handler.lock().unwrap().list_available_output_devices()
}

#[tauri::command]
pub fn select_output_device(audio_handler: tauri::State<Mutex<AudioHandler>>, device_name: String) -> Result<(), AudioHandlerError> {
